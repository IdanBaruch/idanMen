            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               {pillars.map((p) => (
                  <button
                     ...
                     className={`flex items-center justify-between p-6 rounded-[2.5rem] border-2 transition-all ${p.isCompleted ? 'bg-indigo-600/10 border-indigo-500/30' : 'bg-white/5 border-white/10 opacity-60'
                        }`}
                  >
                     ...
                     <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center ${p.isCompleted ? 'bg-indigo-500 border-indigo-500 text-white' : 'border-slate-700'
                        }`}>
