Below is the system prompt designed for the Emuna 2.0 AI Engine (The Cognitive Alchemist). This prompt instructs the AI to act as a real-time CBT therapist, specifically tailored for de-escalating paranoid thoughts and auditory hallucinations.
